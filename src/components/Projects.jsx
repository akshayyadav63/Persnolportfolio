  ...
  const projects = [
    {
      ...
      description: 'A comprehensive talent showcase platform designed to enable professionals to register and showcase their skills with admin approval for quality control. Clients can browse talent profiles and send hire requests through a seamless and scalable system featuring real-time notifications and user-friendly interfaces.',
    ...
    },
    {
      ...
      description: 'A comprehensive e-commerce platform integrated with Multi-Level Marketing (MLM) system. Features complete product management, secure user authentication, commission tracking, referral system, and advanced analytics dashboard for business growth.',
    ...
    },
    {
      ...
      description: 'Advanced AI-powered SaaS platform with secure authentication and subscription billing using Clerk. Integrates Gemini API for intelligent content generation and resume analysis, plus ClipDrop API for professional image editing and generation.',
    ...
    },
    {
      ...
      description: 'Sophisticated resume builder featuring customizable templates, real-time live preview, and multi-format export (PDF, Word, HTML). Includes JWT authentication, resume saving/editing capabilities, guest access, and responsive design.',
    ...
    },
    {
      ...
      description: 'AI-powered precision farming platform achieving 70% accurate crop predictions through advanced soil and weather data analysis. Features secure JWT authentication, OTP login system, multilingual support, and responsive design.',
      ...
      <div className="container-max relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-gray-200 transform hover:-translate-y-1"
            >
              {/* Project Image */}
              <div className="relative overflow-hidden h-64 bg-gray-50">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-white/90 backdrop-blur-sm text-gray-700 px-3 py-1 rounded-full text-xs font-semibold border border-white/20">
                    {project.category}
                  </span>
                </div>
                ...
                {project.liveLink !== '#' && (
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <a
                      ...
                      className="bg-white text-gray-900 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors duration-200 transform hover:scale-105 flex items-center space-x-2"
                    >
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="bg-gray-50 hover:bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium transition-colors duration-200 border border-gray-200"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors duration-200 group/btn px-4 py-2 rounded-lg hover:bg-gray-50"
                  >
                  ...
                  {project.liveLink !== '#' ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`flex items-center space-x-2 bg-gradient-to-r ${project.gradient} text-white px-6 py-2 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 group/btn`}
                    >
                    ...
                    <span className="flex items-center space-x-2 bg-gray-400 text-white px-6 py-2 rounded-lg cursor-not-allowed opacity-60">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">
                    Visit my GitHub profile for additional projects, contributions, and code samples
                  </p>
                </div>
              </div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center space-x-2 whitespace-nowrap"
              >
