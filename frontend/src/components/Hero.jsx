...
//                 {/* Floating Skills Badges - Positioned around photo with proper spacing */}
                
//                 {/* Left Side - Frontend Technologies */}
//                 <div className="absolute -left-24 top-12 bg-blue-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-blue-400/30 animate-subtle-float animation-delay-3000 hover:scale-110 transition-transform duration-300">
//                   <span className="text-blue-300 text-sm font-medium">React.js</span>
//                 </div>
                
//                 <div className="absolute -left-28 top-32 bg-orange-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-orange-400/30 animate-subtle-float animation-delay-3500 hover:scale-110 transition-transform duration-300">
//                   <span className="text-orange-300 text-sm font-medium">HTML</span>
//                 </div>
                
//                 <div className="absolute -left-24 top-52 bg-cyan-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-cyan-400/30 animate-subtle-float animation-delay-4000 hover:scale-110 transition-transform duration-300">
//                   <span className="text-cyan-300 text-sm font-medium">CSS</span>
//                 </div>
                
//                 <div className="absolute -left-32 top-72 bg-teal-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-teal-400/30 animate-subtle-float animation-delay-4500 hover:scale-110 transition-transform duration-300">
//                   <span className="text-teal-300 text-sm font-medium">Tailwind</span>
//                 </div>
                
//                 <div className="absolute -left-24 bottom-20 bg-yellow-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-yellow-400/30 animate-subtle-float animation-delay-5000 hover:scale-110 transition-transform duration-300">
//                   <span className="text-yellow-300 text-sm font-medium">JavaScript</span>
//                 </div>

//                 {/* Right Side - Backend & Database Technologies */}
//                 <div className="absolute -right-24 top-12 bg-green-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-green-400/30 animate-subtle-float animation-delay-3200 hover:scale-110 transition-transform duration-300">
//                   <span className="text-green-300 text-sm font-medium">Node.js</span>
//                 </div>
                
//                 <div className="absolute -right-28 top-32 bg-gray-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-gray-400/30 animate-subtle-float animation-delay-3700 hover:scale-110 transition-transform duration-300">
//                   <span className="text-gray-300 text-sm font-medium">Next.js</span>
//                 </div>
                
//                 <div className="absolute -right-24 top-52 bg-emerald-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-emerald-400/30 animate-subtle-float animation-delay-4200 hover:scale-110 transition-transform duration-300">
//                   <span className="text-emerald-300 text-sm font-medium">MongoDB</span>
//                 </div>
                
//                 <div className="absolute -right-32 top-72 bg-red-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-red-400/30 animate-subtle-float animation-delay-4700 hover:scale-110 transition-transform duration-300">
//                   <span className="text-red-300 text-sm font-medium">Flask</span>
//                 </div>
                
//                 <div className="absolute -right-24 bottom-20 bg-indigo-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-indigo-400/30 animate-subtle-float animation-delay-5200 hover:scale-110 transition-transform duration-300">
//                   <span className="text-indigo-300 text-sm font-medium">SQL</span>
//                 </div>

//                 {/* Top Side - Additional Skills */}
//                 <div className="absolute -top-12 left-16 bg-purple-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-purple-400/30 animate-subtle-float animation-delay-3400 hover:scale-110 transition-transform duration-300">
//                   <span className="text-purple-300 text-sm font-medium">DSA</span>
//                 </div>
                
//                 <div className="absolute -top-12 right-16 bg-violet-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-violet-400/30 animate-subtle-float animation-delay-3600 hover:scale-110 transition-transform duration-300">
//                   <span className="text-violet-300 text-sm font-medium">Express.js</span>
//                 </div>

//                 {/* Bottom Side - More Skills */}
//                 <div className="absolute -bottom-12 left-16 bg-pink-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-pink-400/30 animate-subtle-float animation-delay-5400 hover:scale-110 transition-transform duration-300">
//                   <span className="text-pink-300 text-sm font-medium">Python</span>
//                 </div>
                
//                 <div className="absolute -bottom-12 right-16 bg-amber-600/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-amber-400/30 animate-subtle-float animation-delay-5600 hover:scale-110 transition-transform duration-300">
//                   <span className="text-amber-300 text-sm font-medium">Git</span>
//                 </div>
